...
const Pricing = () => {
  ...
  const handleBuyPremium = (plan) => {
    const whatsappUrl = `https://wa.me/6283863595922?text=.buyprem%20${plan}`;
          ...
          <div className="footer-content">
            ...
            <div className="footer-links-section">
              ...
              <div className="footer-column">
                ...
                <ul className="footer-list">
                  <li>
                    <a href="mailto:sherdi240@gmail.com" className="footer-link footer-contact-link">
                  ...
                  <li>
                    <a href="https://wa.me/6283156669609" target="_blank" rel="noopener noreferrer" className="footer-link footer-contact-link">
                      <svg className="contact-icon" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
